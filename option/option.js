...
async function getCurrentPriceOfBitcoin(data_type) {
    try {
        ...
        const response = await axios.get(`${API_URL}/v2/tickers/?underlying_asset_symbols=BTC&contract_types=call_options,put_options&states=live&expiry_date=20-05-2025`);
